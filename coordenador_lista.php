...
<form>
	<label for="id" class="labelform"> ID </label> <input type="text"
		...
		id="areatecno" value="Tecno" /> Tecno <br /> 
		
		<label for="unidade"class="labelform"> Unidade </label>
		<input type="radio" name="Cidade" id="cidade" value="cidade" /> Cidade </input> 
		<input type="radio"	name="Campus Pelotas" id="campuspel" value="Campus Pelotas" /> Campus Pelotas </input><br /> <br />
