		...
		<div class="row">
			...
			<div class=" col-lg-8" id="menu">
				<ul class="nav nav-pills pull-right ">
					<li role="presentation"	class="<?=( isset($_GET['menu']) && $_GET['menu']=='dashboard')?'active':'';?>">
					<a href="aluno_lista.php?menu=dashboard">Dashboard</a></li>
					<li role="presentation"	class="<?=( isset($_GET['menu']) && $_GET['menu']=='aluno')?'active':'';?>">
					<a href="aluno_lista.php?menu=aluno&formulario=0">Alunos</a></li>
					<li role="presentation"	class="<?=( isset($_GET['menu']) && $_GET['menu']=='professor')?'active':'';?>">
					<a href="aluno_lista.php?menu=professor&formulario=0">Professores</a></li>
					<li role="presentation" class="<?=( isset($_GET['menu']) && $_GET['menu']=='coordenador')?'active':'';?>">
					<a href="aluno_lista.php?menu=coordenador&formulario=0">Coordenadores</a></li>
					<li role="presentation"	class="<?=( isset($_GET['menu']) && $_GET['menu']=='sair')?'active':'';?>">
					<a href="aluno_lista.php?menu=sair">Sair</a></li>
				</ul>
			</div>
		</div>
...
<div id="content">
	<div class="container">
		<?php if (isset ( $_GET ['menu'] ) && $_GET ['menu'] == 'aluno'){?>
			<div class="row">
				<h1>Dashboard</h1>
				<ol class="breadcrumb">
		...
		<?php if (isset ( $_GET ['menu'] ) && $_GET ['menu'] == 'coordenador'){?> 
				<div class="row">
					<h1>Dashboard</h1>
					<ol class="breadcrumb">
						<li><a href="#">Maestro</a></li>
				...
				<form action="" method="post">
					...
					<br/>
					<br/>
					<textarea name="t1" placeholder="Digite"/></textarea>					
					<br/>
					<br/>
					<input type="submit"/>
 				</form>    		 	       
		...
		<?php if (isset ( $_GET ['menu'] ) && $_GET ['menu'] == 'professor'){?>
			<div class="row">
				<h1>Dashboard</h1>
				<ol class="breadcrumb">
					<li><a href="#">Maestro</a></li>
			...
			<?php if(isset($_GET['formulario'])&& $_GET['formulario']==0){ ?>
				<div class="row">
					<a href="aula_maestro" class=" btn btn-success"> Adicionar</a>
					<table class="table table-striped table-bordered table-hover">
						<tr>
							<td>ID</td>
							<td>Usuario</td>
		...
		<?php if (isset ( $_GET ['menu'] ) && $_GET ['menu'] == 'sair'){ ?>
			 <div class="row">
				<h1>Dashboard</h1>
				<ol class="breadcrumb">
					<li><a href="#">Maestro</a></li>
