		...
		<div class="row">
			...
			<div class=" col-lg-8" id="menu">
				<ul class="nav nav-pills pull-right ">
					...
					<a href="aluno_lista.php?menu=aluno">Alunos</a></li>
					<li role="presentation"	class="<?=( isset($_GET['menu']) && $_GET['menu']=='professor')?'active':'';?>">
					<a href="aluno_lista.php?menu=professor">Professores</a></li>
					<li role="presentation" class="<?=( isset($_GET['menu']) && $_GET['menu']=='coordenador')?'active':'';?>">
					<a href="aluno_lista.php?menu=coordenador">Coordenadores</a></li>
